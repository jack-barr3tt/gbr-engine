...
- **Run:** `./dev.sh` — applies schema via Atlas, starts tmux session `gbr-dev` with 8 windows (api, queuer, trust, vstp, fetcher, schedule, bplan, gemini). Attach and work in each.
